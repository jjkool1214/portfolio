    ...
    return (
        <>
            <div className="justify-center align-center flex flex-row pt-[5%]">
                <div id={"full-bio"} className={"flex-col space-x-2 ps-[7.5%] w-[70%] pe-[5%] "}>
                ...
                <div className="flex justify-center drop-shadow">
                    <img className={"img-fluid border-4 shadow-blue-002 object-cover "} src={"src/assets/photos/headshot.jpg"} alt="headshot"/>
                </div>
            </div>
